/**
 *  Child Pressure WC Measurement ST
 *
 *  Copyright 2022
 *
 ...
 */
metadata {
	definition (name: "Child Pressure WC Measurement", namespace: "ogiewon", author: "Wes Wright") {
		capability "Sensor"
...
def parse(String description) {
    ...
    if (name && value) {
        // Update device
        sendEvent(name: name, value: value, unit:"WC")
